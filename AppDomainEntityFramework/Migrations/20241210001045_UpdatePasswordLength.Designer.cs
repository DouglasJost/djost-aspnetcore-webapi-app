...
namespace AppDomainEntityFramework.Migrations
{
    ...
    [Migration("20241210001045_UpdatePasswordLength")]
            ...
            modelBuilder.Entity("AppDomainEntities.Entities.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "JWT",
                            Inactive = false,
                            LastModifiedDate = new DateTime(2024, 12, 10, 0, 10, 44, 921, DateTimeKind.Utc).AddTicks(7610),
                            LastName = "Issuer",
                            UserDefined = true
                        });
                });
            ...
            modelBuilder.Entity("AppDomainEntities.Entities.UserLogin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserAccountId = new Guid("4ec76740-6895-40f4-abb8-3fbab440fff1"),
                            Inactive = false,
                            LastModifiedDate = new DateTime(2024, 12, 10, 0, 10, 44, 921, DateTimeKind.Utc).AddTicks(7684),
                            Login = "JwtIssuer",
