...
namespace AppDomainEntityFramework.Migrations
{
    ...
    [Migration("20241212205535_AddedInitialMusicCollectionEntityClasses")]
    partial class AddedInitialMusicCollectionEntityClasses
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppDomainEntities.Entities.UserAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "JWT",
                            Inactive = false,
                            LastModifiedDate = new DateTime(2024, 12, 12, 20, 55, 35, 107, DateTimeKind.Utc).AddTicks(6754),
                            LastName = "Issuer",
                            UserDefined = true
                        });
                });
            ...
            modelBuilder.Entity("AppDomainEntities.Entities.UserLogin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserAccountId = new Guid("4ec76740-6895-40f4-abb8-3fbab440fff1"),
                            Inactive = false,
                            LastModifiedDate = new DateTime(2024, 12, 12, 20, 55, 35, 107, DateTimeKind.Utc).AddTicks(6874),
                            Login = "JwtIssuer",
